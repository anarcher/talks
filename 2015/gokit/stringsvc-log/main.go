...
func main() {
	...
	uppercase = logging(log.NewContext(logger).With("method", "uppercase"))(uppercase) // HL
	count = logging(log.NewContext(logger).With("method", "count"))(count)             // HL
	...
	logger.Log("res", res.(UppercaseResponse).V, "err", err)
